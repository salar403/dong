...
SECRET_KEY = "django-insecure-w009)3tg7g**m=)v3%op^)6m3wr1a#hw0-7dff$%-_l*w%67wf"
...
CACHES = {
    ...
    "routine_timing": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": f"redis://{BACKEND_REDIS_HOST}:{BACKEND_REDIS_PORT}/{REDIS_ROUTINE_TIMING}",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        },
    },
